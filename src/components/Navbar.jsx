...
const Navbar = () => {
  ...
  return (
    ...
    <div>
     ...
     <nav className="bg-[#EAEAEA] overflow-hidden border-gray-200 h-14 absolute w-full px-2 sm:px-4 py-[3px] top-0 left-0 dark:bg-gray-900">
        <div className="container flex items-center justify-between h-full">
              <div className="flex gap-2 items-center">
                 <button onClick={() => setIsVisible(true)}><Option size='2rem' color='#D13256'/></button>
                 <Link to='/dashboard'><img src={logo} alt="" className="w-32" /></Link>
