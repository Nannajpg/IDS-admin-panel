...
function StickerForm() {
  ...
  return (
    <div className="flex items-center h-screen">
      ...
      >
        <label htmlFor="playerName" className="block text-xs font-bold mb-2">
          Nombre de Jugador:
        </label>
        <input
          name="playerName"
        ...
        <label htmlFor="position" className="block text-xs font-bold mb-2">
          Posición:
        </label>
        <select
          name="position"
        ...
        <label htmlFor="height" className="block text-xs font-bold mb-2">
          Altura (cm):
        </label>
        <input
          name="height"
        ...
        <label htmlFor="weight" className="block text-xs font-bold mb-2">
          Peso (Kg):
        </label>
        <input
          name="weight"
