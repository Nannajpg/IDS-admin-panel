        ...
        <table className="w-full">
            <thead className="bg-gradient-to-r header-table-rounded from-[#D13256] to-[#F75845] text-white">
              <tr>
                ...
                <td className="p-3 w-30 text-sm font-bold tracking-wide text-center max-[650px]:hidden">Competición</td>
                ...
                <td className="p-3 w-30 text-sm font-bold tracking-wide text-center max-[750px]:hidden">Altura (cm)</td>
                <td className="p-3 w-30 text-sm font-bold tracking-wide text-center max-[810px]:hidden">Peso (Kg)</td>
                <td className="p-3 w-30 text-sm font-bold tracking-wide text-center max-[500px]:hidden">% de Aparición</td>
