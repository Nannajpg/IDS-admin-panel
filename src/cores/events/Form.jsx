            ...
            <div className='flex md:w-3/4 w-full gap-[10%] md:gap-[30%]'>
                ...
                <form onSubmit={handleSubmit} className="bg-[#EAEAEA] rounded-2xl text-black shadow-md">
                    ...
                    <div className='text-lg pt-2 px-7 text-[#3D405B] bg-[#F1F1F1]'>
                        ...
                        <input name='eventName' type="text" placeholder="Nombre" onChange={handleChange} className="w-full p-1 rounded-2xl bg-white mb-2 hover:bg-[#FCC0A8]" required />
                        <label htmlFor="status" className="block font-bold mb-2">Estado de Competición</label>
                        <select name="status" className="w-full p-1 rounded-2xl bg-white mb-2 hover:bg-[#FCC0A8]" onChange={handleChange} placeholder="Estado del Evento" required>
