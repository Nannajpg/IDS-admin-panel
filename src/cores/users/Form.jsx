                ...
                <form onSubmit={handleSubmit} className="bg-[#EAEAEA] rounded-2xl text-black w-">
                    ...
                    <div className='text-lg pt-3 px-7 gap-y-8 text-[#3D405B] bg-[#F1F1F1] shadow-md'>
                        <div>
                            ...
                            <input name='name' type="text" placeholder="Nombre" onChange={handleChange} className="w-full p-1 rounded-2xl bg-white mb-2 hover:bg-[#FCC0A8]" value={user.name} required/>
                        </div>
                        <div>
                            <label htmlFor="role" className="block font-bold mb-2">Tipo de usuario</label>
                            <select name="role" className="w-full p-1 rounded-2xl bg-white mb-2 hover:bg-[#FCC0A8]" value={user.role} onChange={handleChange} required placeholder="Rol del Usuario">
                        ...
                        <div>
                            ...
                            <input name='email' type="email" placeholder="Email" value={user.email} onChange={handleChange} className="w-full p-1 rounded-2xl bg-white mb-2 hover:bg-[#FCC0A8]" required/>
                        </div> 
                        <div>
                            <label htmlFor="password" className="block font-bold mb-2">Contraseña</label>
                            <input name='password' type="password" placeholder="Contraseña" onChange={handleChange} className="w-full p-1 rounded-2xl bg-white mb-2 hover:bg-[#FCC0A8]" required/>
                        </div>
                    </div>
